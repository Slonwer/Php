    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="text-center bg-secondary mt-1 text-light">LISTA DE CURSO:</h2>
                    </div>
                    <div class="col-sm-2">
                        <button class="btn btn-primary pull-center mt-1 bg-secondary" onclick="window.location.href= 'index.php'">Voltar</button>
                    </div>
                    <div class="col-sm-2">
                        <button class="btn btn-primary pull-center mt-1 bg-secondary" onclick="window.location.href= 'cadcurso.php'">Cadastrar</button>
                    </div>
                                ...
                                <tr>
                                    <?php if (isset($nome)) { ?>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                            echo "<a href='editcurso.php?id=" . $codigo . "&nome=" . $nome . "&instituicao=" . $instituicao . "&tempo=" . $tempo ."' title='Editar'><i class='fa fa-pencil-square fa-2x text-secondary'></i></a>";
                                            ?>
