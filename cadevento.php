...
<html lang="en">
    ...
    <body id="page-top">
        ...
        " method="POST">
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="text-center bg-secondary mb-3 text-light">CADASTRAR EVENTO:</h2>
                </div>
            </div>
            <div class="row">    
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-12 mb-3">
                    ...
                    <input type="button" name="listar" class="btn btn-primary pull-right  bg-secondary" value="Listar Dados" onclick="window.location.href='listeve.php'">
