...
<body id="page-top">
    ...
    <div class="container">
        ...
        " method="POST">
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="text-center bg-secondary mb-3 text-light">ALTERAÇÃO DE MÓDULO/SÉRIE:</h2>
                </div>
                ...
                <div class="form-group col-sm-12  mb-3">
                    <select name="modulo" class="form-control" required>
                        ...
                        <?php if($modulo === "primeiro"){?>

                        <option value="primeiro" selected> Primeiro Modulo</option>
                        <option value="segundo"> Segundo Modulo</option>
                        <option value="terceiro"> Terceiro Modulo</option>
                        
                        <?php }elseif($modulo === "segundo"){?>

                        <option value="primeiro"> Primeiro Modulo</option>
                        <option value="segundo" selected> Segundo Modulo</option>
                        <option value="terceiro"> Terceiro Modulo</option>
                        
                        <?php }elseif($modulo === "terceiro"){?>

                        <option value="primeiro"> Primeiro Modulo</option>
                        <option value="segundo"> Segundo Modulo</option>
                        <option value="terceiro" selected> Terceiro Modulo</option>  
                ...
                <div class="form-group col-sm-12  mb-3">
                    <select name="serie" class="form-control" required>
                        ...
                        <?php if($serie === "primeiro"){?>

                        <option value="primeiro" selected> Primeiro Ano</option>
                        <option value="segundo"> Segundo Ano</option>
                        <option value="terceiro"> Terceiro Ano</option>

                        <?php }elseif($serie === "segundo"){?>

                        <option value="primeiro"> Primeiro Ano</option>
                        <option value="segundo" selected> Segundo Ano</option>
                        <option value="terceiro"> Terceiro Ano</option>

                        <?php }elseif($serie === "terceiro"){?>

                        <option value="primeiro"> Primeiro Ano</option>
                        <option value="segundo"> Segundo Ano</option>
                        <option value="terceiro" selected> Terceiro Ano</option>
